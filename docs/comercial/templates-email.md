...
## E-mail 1 (D0) — por vertical

### Contabilidade
**Assunto:** Horas da equipe no {empresa}: quantas viram produção?
...
> Oi, {contato},
>
> Quem gerencia time técnico híbrido vive o dilema: quer visibilidade de capacidade,
...
### Advocacia
**Assunto:** Produtividade no {empresa}, sem tocar no sigilo

> Oi, {contato}, tudo bem?
>
> Escritórios de advocacia me dizem o mesmo: querem entender o uso das horas da
...
## E-mail 2 (D+4) — prova e simplicidade (todas as verticais)

**Assunto:** RE: (mesmo assunto do e-mail 1)

> {contato}, complemento rápido do meu e-mail de {dia da semana}:
>
...
## E-mail 3 (D+12) — encerramento educado
...
> me responde com um "depois" que eu volto no trimestre que vem.
>
...
- Semana 1: 15–20 envios/dia no máximo (aquecimento do domínio); depois ~30/dia.
- Conferir no hPanel que SPF/DKIM/DMARC do mais351monitor.com.br estão ativos.
- Variar horários (8h30–11h e 14h–17h); nunca disparar dezenas no mesmo minuto.
- Bounce (e-mail inexistente) → corrigir ou apagar o e-mail no CRM na hora.
